...
function L(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, p2, v2, y3, _2, g2, m3 = t5 && t5.__k || w, b10 = l2.length;
  for (f2 = T(u2, l2, m3, f2, b10), a3 = 0; a3 < b10; a3++) null != (p2 = u2.__k[a3]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = a3, _2 = q(n2, p2, h2, i2, r2, o2, e3, f2, c5, s2), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), s2.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
function T(n2, l2, u2, t5, i2) {
  var r2, o2, e3, f2, c5, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = x(null, o2, null, null, null) : g(o2) ? o2 = n2.__k[r2] = x(S, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = x(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c5 = o2.__i = O(o2, u2, f2, a3)) && (a3--, (e3 = u2[c5]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c5 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a3) for (r2 = 0; r2 < s2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = $(e3)), K2(e3, e3));
  return t5;
}
...
function N(n2, l2, u2, t5, i2) {
  ...
  else if ("o" == l2[0] && "n" == l2[1]) r2 = l2 != (l2 = l2.replace(a, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t5 ? u2[s] = t5[s] : (u2[s] = h, n2.addEventListener(l2, r2 ? v : p, r2)) : n2.removeEventListener(l2, r2 ? v : p, r2);
  else {
...
function V(n2) {
  return function(u2) {
    if (this.l) {
      ...
      if (null == u2[c]) u2[c] = h++;
      else if (u2[c] < t5[s]) return;
      return t5(l.event ? l.event(u2) : u2);
    }
  };
}
function q(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, p2, v2, y3, d2, _2, k2, x3, M, $2, I2, P2, A3, H2, T2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t5.__u && (c5 = !!(32 & t5.__u), o2 = [f2 = u2.__e = t5.__e]), (a3 = l.__b) && a3(u2);
  n: if ("function" == typeof T2) try {
    if (k2 = u2.props, x3 = T2.prototype && T2.prototype.render, M = (a3 = T2.contextType) && i2[a3.__c], $2 = a3 ? M ? M.props.value : a3.__ : i2, t5.__c ? _2 = (h2 = u2.__c = t5.__c).__ = h2.__E : (x3 ? u2.__c = h2 = new T2(k2, $2) : (u2.__c = h2 = new C2(k2, $2), h2.constructor = T2, h2.render = Q), M && M.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), x3 && null == h2.__s && (h2.__s = h2.state), x3 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = m({}, h2.__s)), m(h2.__s, T2.getDerivedStateFromProps(k2, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) x3 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), x3 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = m(m({}, i2), h2.getChildContext())), x3 && !p2 && null != h2.getSnapshotBeforeUpdate && (d2 = h2.getSnapshotBeforeUpdate(v2, y3)), A3 = null != a3 && a3.type === S && null == a3.key ? E2(a3.props.children) : a3, f2 = L(n2, g(A3) ? A3 : [A3], u2, t5, i2, r2, o2, e3, f2, c5, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), _2 && (h2.__E = h2.__ = null);
  } catch (n3) {
  ...
  else null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = G(t5.__e, u2, t5, i2, r2, o2, e3, c5, s2);
...
function E2(n2) {
  return "object" != typeof n2 || null == n2 || n2.__b > 0 ? n2 : g(n2) ? n2.map(E2) : m({}, n2);
}
function G(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, p2, v2, y3, w2, _2, m3 = i2.props || d, k2 = t5.props, x3 = t5.type;
  ...
  if (null == x3) m3 === k2 || c5 && u2.data == k2 || (u2.data = k2);
    ...
    if (e3 = e3 && n.call(u2.childNodes), !c5 && null != e3) for (m3 = {}, a3 = 0; a3 < u2.attributes.length; a3++) m3[(y3 = u2.attributes[a3]).name] = y3.value;
    ...
    else if (p2 && (u2.innerHTML = ""), L("template" == t5.type ? u2.content : u2, g(v2) ? v2 : [v2], t5, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && $(i2, 0), c5, s2), null != e3) for (a3 = e3.length; a3--; ) b(e3[a3]);
